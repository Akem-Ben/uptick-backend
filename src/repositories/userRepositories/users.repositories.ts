...
import errorHandlersUtilities from "../../utilities/errorHandlers/errorHandlers.utilities";
...
const userRepositories = {
  ...
  create: async (data: any, transaction?:Transaction) => {
    try {
      ...
      throw errorHandlersUtilities.createError(`Error registering user, please try again`, 500);
    }
  },
